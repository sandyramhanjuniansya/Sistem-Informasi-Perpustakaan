...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan UTS</h4>
        UPT Perpustakaan Universitas Teknologi Sumbawa [UTS] sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia 
		...
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika UTS. 
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber 
		referensi lain guna menunjang proses pembelajaran di UTS.
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. 
